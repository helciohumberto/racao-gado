                ...
                {animaisFiltrados.map((animal) => (
                  ...
                  >
                    ...
                    <td className="p-4 text-green-400">
                      {animal.pesoInicial.toFixed(1)} kg
                    </td>
                    <td className="p-4">
                      <span
                        className={`px-2 py-1 rounded text-xs ${animal.estado === "ATIVO" ? "bg-green-900 text-green-300" : "bg-red-900 text-red-300"}`}
                      >
                        {animal.estado}
                      </span>
                    </td>
            ...
            >
              ...
              <div className="space-y-2 text-sm">
                ...
                <p>
                  ...
                  {animalSelecionado.sexo === "M" ? "Macho" : "Fêmea"}
                </p>
                <p>
                  <span className="text-gray-400">Lote:</span>{" "}
                  {animalSelecionado.lote?.nome}
                </p>
                <p>
                  <span className="text-gray-400">Peso inicial:</span>{" "}
                  {animalSelecionado.pesoInicial.toFixed(1)} kg
                </p>
                <p>
                  <span className="text-gray-400">Estado:</span>{" "}
                  {animalSelecionado.estado}
                </p>
              </div>
              <button
                onClick={() => setAnimalSelecionado(null)}
